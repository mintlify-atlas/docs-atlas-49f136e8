...
description: "Manage the MC Modeler image library: upload, organise into folders, link images to BPMN elements, and understand cloud storage vs. local IndexedDB modes."
---
