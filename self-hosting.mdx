---
title: "Self-Hosting MC Modeler: Supabase and Static Deploy"
sidebarTitle: Self-Hosting
description: "Deploy your own MC Modeler instance: run Supabase migrations, set two environment variables, build with Vite, and host the static SPA on Vercel or any CDN."
---
